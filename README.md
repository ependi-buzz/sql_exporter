...
Get Prometheus SQL Exporter, either as a [packaged release](https://github.com/ependi-buzz/sql_exporter/releases/latest), as a [Docker image](https://hub.docker.com/r/githubfree/sql_exporter) or
build it yourself:
...
[`documentation/sql_exporter.yml`](https://github.com/ependi-buzz/sql_exporter/tree/master/documentation/sql_exporter.yml).
You will find ready to use "standard" DBMS-specific collector definitions in the
[`examples`](https://github.com/ependi-buzz/sql_exporter/tree/master/examples) directory. You may contribute your own collector
